...
na_count <- sum(is.na(properties_merged[, c("Demographic_cluster", "Political_cluster", "Tax_cluster")]))
...
na_rows <- subset(properties_merged, is.na(Demographic_cluster) | is.na(Political_cluster) | is.na(Tax_cluster))
