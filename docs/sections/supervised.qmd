...
```{r}
#filter price on less than 3.3M and year 2016-2024
properties_filtered_3 <- properties_filtered_2 %>% filter(price < 3300000 & year_category =="2016-2024")
# Model Building
...
#apply the RF model as a regression
rf_model <- randomForest(price ~ square_meters + number_of_rooms + property_type  + Political_cluster + Tax_cluster + Demographic_cluster, data=testData3, ntree=500, importance=TRUE)
