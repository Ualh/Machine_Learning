...
```{r}
#filter properties_filtered based on the canton valais, tessin, vaud, Berne, Fribourg
properties_filtered <- properties_filtered %>% filter(canton %in% c("valais", "ticino", "vaud", "bern", "Fribourg"))
```
