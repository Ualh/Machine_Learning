...
Note that even with others splitting of the dataset between the test and the training, the test set is always higher that might indicate that our model isn't perfect
```{r}
