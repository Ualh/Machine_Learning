...
```{python}
#retrieve the r dataframe in python
properties = r.properties
import pandas as pd
properties.head()

#read AMTOVZ_CSV_LV95.csv
amto = pd.read_csv("Project/Machine_Learning/data/AMTOVZ_CSV_LV95.csv", sep=';', encoding='latin1')
...
commune_prep <- read.csv("/Users/hugot/Desktop/HEC/ML/Projet/Machine_Learning/data/commune_data.csv", sep = ";")
