...
Next, we used the AMTOVZ_CSV_LV95 dataset to retrieve additional information such as the city and canton based on the extracted zip codes. This involved the following steps:
```{r zip}
