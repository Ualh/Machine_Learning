...
## Price between 0 and 5 millions
...
```
Compared to other cantons, Geneva has a distinct distribution. 
Canton Vaud, Valais, Tessin, Bern, and Fribourg are where the majority of the listed properties are concentrated.
