...
The canton of Vaud, Valais, Tessin, Bern, and Fribourg are where the majority of the listed properties are concentrated in our data set.Their distribution show that the majority of properties are worth between 0,4 and 2 million.
...
Here are the distribution of prices per number of rooms. Please note that we didn't display the properties with more than 12 rooms as the number of observations for these are very scattered.
...
```
Based on this graphs, the political clusters 1, 2 and 4 are similar with a mean price of properties around CHF 1,1 million. The political cluster 3 has the higher mean price with CHF 1,75 million. And the 5th one has a mean around CHF 1,3 million.
